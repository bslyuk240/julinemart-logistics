    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 brand-gradient flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <JulineMartLogo className="h-20 w-20 sm:h-24 sm:w-24 object-contain mx-auto mb-8 drop-shadow-lg rounded-full" />
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
            Your Reach.<br />Your Rewards.
          </h1>
          <p className="text-primary-200 text-lg max-w-sm mx-auto leading-relaxed">
            Track your coupon code, sales, and commission — all in one place.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Influencer Portal</p>
          </div>

          <div className="bg-white rounded-2xl shadow-card border border-gray-100 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Welcome back</h2>
            <p className="text-gray-500 text-sm mb-7">Sign in to your influencer dashboard</p>
