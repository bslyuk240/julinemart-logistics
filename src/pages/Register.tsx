...
const BANKS = [
  ...
  'First City Monument Bank (FCMB)','Globus Bank','GT Bank','Heritage Bank',
  'Keystone Bank','Kuda Microfinance Bank','Opay','Palmpay','Polaris Bank',
  'Stanbic IBTC Bank','Standard Chartered Bank','Sterling Bank','UBA',
  'Union Bank','Unity Bank','Wema Bank','Zenith Bank',
];
