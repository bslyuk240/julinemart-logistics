...
// browser — BarcodeDetector isn't available on iOS Safari or in some
// Android webviews, and this app can't assume which one a rider's phone has.
export function Scanner({ title, hint, onDetect, onClose }: ScannerProps) {
        ...
        {(state === 'denied' || state === 'unsupported') && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 px-8 text-center">
            ...
            <p className="text-sm text-white/70">
              {state === 'denied'
                ? 'Camera access was denied. Enable it in your phone settings, or type the code from the label.'
                : "This browser can't access the camera. Type the code from the label."}
            </p>
            <form
