    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="fixed left-1/2 top-16 -translate-x-1/2 w-[calc(100vw-1.5rem)] max-w-[24rem] sm:absolute sm:left-1/2 sm:top-full sm:mt-2 sm:w-80 sm:max-w-none bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[calc(100vh-4rem)] flex flex-col">
            {/* Header */}
